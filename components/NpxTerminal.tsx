...
const COMMANDS: Record<string, () => Line[]> = {
  ...
  whoami: () => [
    ...
    { text: "" },
    { text: "  Role       Senior Software Engineer · AI · Fullstack · Web3", color: "var(--text-primary)" },
    ...
    { text: "" },
    { text: "  ✓  5+ yrs · 10+ products shipped 0→1 (web, mobile, onchain)", color: "var(--text-secondary)" },
    { text: "  ✓  Built AI inventory on Collect Shiny — MCP + RAG in prod", color: "var(--accent-purple)" },
    { text: "  ✓  Owned $30M+ MON token launch: presale, staking, vesting", color: "var(--text-secondary)" },
    { text: "  ✓  Tech Lead @ PopSocial — led 4 eng, promoted in 5 months", color: "var(--text-secondary)" },
    { text: "  ✓  Proof-of-Activity protocol → $1M AVAX grant (Pixelmon)", color: "var(--accent-green)" },
  ...
  "ls projects/": () => [
    ...
    { text: "  nextflow.sh     AI workflow DAG engine · Next.js + Trigger.dev · realtime runs", color: "var(--accent-green)", href: "https://github.com/smrnjeet222/nextflow" },
    { text: "  grok_wiki.sh    Local-first wiki reader · React 19 + Bun · Mermaid, offline", color: "var(--accent-yellow)", href: "https://github.com/smrnjeet222/grok-wiki-viewer" },
  ...
  "cat skills.txt": () => [
    ...
    { text: "" },
    { text: "  AI/Agents    LLM · RAG · MCP · Agent Orchestration · Vector Search · Evals", color: "var(--accent-purple)" },
    { text: "  Languages    TypeScript · Python · Go · Solidity · Rust (reading)", color: "var(--text-primary)" },
    { text: "  Frontend     React · Next.js · React Native · TanStack · Tailwind CSS", color: "var(--accent-cyan)" },
    { text: "  Backend      Go/Fiber · Node.js · NestJS · FastAPI · gRPC · WebSockets", color: "var(--accent-green)" },
    { text: "  Data         PostgreSQL · pgvector · Redis · Kafka · ClickHouse · MongoDB", color: "var(--accent-yellow)" },
    { text: "  Cloud/Infra  AWS · Docker · CI/CD · OpenTelemetry · Grafana · Sentry", color: "var(--accent-cyan)" },
    { text: "  Onchain      Solidity · EVM · Foundry · Subgraphs · LayerZero · Solana · Sui", color: "var(--text-primary)" },
    { text: "" },
  ],
  ...
  "cat resume": () => [
    ...
    { text: "  Impact      $30M+ launches · $1M AVAX grant · ETHIndia Winner", color: "var(--accent-yellow)" },
    { text: "  Highlight   AI marketplace (MCP+RAG) · CycloSwap (1st Solana AMM)", color: "var(--accent-cyan)" },
    { text: "" },
  ...
  "hire smrnjeet": () => [
    ...
    { text: "  ✓  AI engineering (LLM, RAG, agents)", color: "var(--accent-green)" },
    { text: "  ✓  Fullstack product engineering", color: "var(--accent-green)" },
    { text: "  ✓  Web3 protocol engineering", color: "var(--accent-green)" },
